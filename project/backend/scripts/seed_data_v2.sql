...
INSERT INTO tracked_items (name, keywords, sku, mpn, category_id, marketplace, target_price, alert_threshold, min_deal_score, is_enabled, search_interval, scam_floor, benchmark_median, pcpp_product_id, notes) VALUES
    ...
    ('Hynix 64GB DDR4-3200 ECC HMAA8GR7AJR4N-XN', 'SK Hynix HMAA8GR7AJR4N-XN 64GB DDR4 ECC RDIMM server memory', 'HMAA8GR7AJR4N-XN', 'HMAA8GR7AJR4N-XN', '170083', 'ebay', 230.00, 0.2, 60, true, 1200, 160.00, 300.00, NULL, 'QVL DDR4-3200 watch (2026-06-30). Priced via dev eBay Browse API 2026-06-30 (active BIN asks, floor-anchored).'),
    ('Micron 64GB DDR4-3200 ECC MTA36ASF8G72PZ-3G2E1VI', 'Micron MTA36ASF8G72PZ-3G2E1VI 64GB DDR4 ECC RDIMM server memory', 'MTA36ASF8G72PZ-3G2E1VI', 'MTA36ASF8G72PZ-3G2E1VI', '170083', 'ebay', 230.00, 0.2, 60, true, 1200, 160.00, 300.00, NULL, 'QVL DDR4-3200 watch (2026-06-30). Cell die OBE45D9XPC. Priced via dev eBay Browse API 2026-06-30 (active BIN asks, floor-anchored).'),
    ('Micron 64GB DDR4-3200 ECC MTA36ASF8G72PZ-3G2E1TI', 'Micron MTA36ASF8G72PZ-3G2E1TI 64GB DDR4 ECC RDIMM server memory', 'MTA36ASF8G72PZ-3G2E1TI', 'MTA36ASF8G72PZ-3G2E1TI', '170083', 'ebay', 230.00, 0.2, 60, true, 1200, 160.00, 300.00, NULL, 'QVL DDR4-3200 watch (2026-06-30). Cell die OAE45D9XPC. Priced via dev eBay Browse API 2026-06-30 (active BIN asks, floor-anchored).'),
    ('Crucial 32GB DDR4-3200 ECC CT32G4RFD432A.36FE2', 'Crucial CT32G4RFD432A 32GB DDR4 ECC RDIMM server memory', 'CT32G4RFD432A.36FE2', 'CT32G4RFD432A.36FE2', '170083', 'ebay', 100.00, 0.2, 60, true, 1200, 75.00, 140.00, NULL, 'QVL DDR4-3200 watch (2026-06-30). One row for both cell dies on the QVL (9CE75D9WFK / 8SE75D9WFK — same module P/N). Priced via dev eBay Browse API 2026-06-30 (active BIN asks, floor-anchored).'),
    ('Innodisk 32GB DDR4-3200 ECC M4R0-BGS2BCEM-J02', 'Innodisk M4R0-BGS2BCEM-J02 32GB DDR4 ECC RDIMM server memory', 'M4R0-BGS2BCEM-J02', 'M4R0-BGS2BCEM-J02', '170083', 'ebay', 100.00, 0.2, 60, true, 1200, 75.00, 140.00, NULL, 'QVL DDR4-3200 watch (2026-06-30). Samsung K4AAG085WA die. Priced via dev eBay Browse API 2026-06-30 (active BIN asks, floor-anchored).'),
    ('Kingston 32GB DDR4-3200 ECC KSM32RD4/32MEI', 'Kingston KSM32RD4/32MEI 32GB DDR4 ECC RDIMM server memory', 'KSM32RD4/32MEI', 'KSM32RD4/32MEI', '170083', 'ebay', 100.00, 0.2, 60, true, 1200, 75.00, 140.00, NULL, 'QVL DDR4-3200 watch (2026-06-30). Priced via dev eBay Browse API 2026-06-30 (active BIN asks, floor-anchored).'),
    ('Micron 32GB DDR4-3200 ECC MTA18ASF4G72PZ-3G2F1UI', 'Micron MTA18ASF4G72PZ-3G2F1UI 32GB DDR4 ECC RDIMM server memory', 'MTA18ASF4G72PZ-3G2F1UI', 'MTA18ASF4G72PZ-3G2F1UI', '170083', 'ebay', 100.00, 0.2, 60, true, 1200, 75.00, 140.00, NULL, 'QVL DDR4-3200 watch (2026-06-30). Cell die IRF75D8CJT. Priced via dev eBay Browse API 2026-06-30 (active BIN asks, floor-anchored).'),
    ('Micron 32GB DDR4-3200 ECC MTA18ASF4G72PDZ-3G2E1UI', 'Micron MTA18ASF4G72PDZ-3G2E1UI 32GB DDR4 ECC RDIMM server memory', 'MTA18ASF4G72PDZ-3G2E1UI', 'MTA18ASF4G72PDZ-3G2E1UI', '170083', 'ebay', 100.00, 0.2, 60, true, 1200, 75.00, 140.00, NULL, 'QVL DDR4-3200 watch (2026-06-30). Cell die OBE45D9ZFV. Priced via dev eBay Browse API 2026-06-30 (active BIN asks, floor-anchored).'),
    ('Micron 32GB DDR4-3200 ECC MTA18ASF4G72PZ-3G2F1TI', 'Micron MTA18ASF4G72PZ-3G2F1TI 32GB DDR4 ECC RDIMM server memory', 'MTA18ASF4G72PZ-3G2F1TI', 'MTA18ASF4G72PZ-3G2F1TI', '170083', 'ebay', 100.00, 0.2, 60, true, 1200, 75.00, 140.00, NULL, 'QVL DDR4-3200 watch (2026-06-30). Cell die ISF75D8CJT. Priced via dev eBay Browse API 2026-06-30 (active BIN asks, floor-anchored).'),
    ...
    ('SMART 32GB DDR4-3200 ECC STB724G4ASR32P2-FM', 'SMART STB724G4ASR32P2-FM 32GB DDR4 ECC RDIMM server memory', 'STB724G4ASR32P2-FM', 'STB724G4ASR32P2-FM', '170083', 'ebay', 100.00, 0.2, 60, true, 1200, 75.00, 140.00, NULL, 'QVL DDR4-3200 watch (2026-06-30). Micron 3ER75D8BPH die. Priced via dev eBay Browse API 2026-06-30 (active BIN asks, floor-anchored).'),
