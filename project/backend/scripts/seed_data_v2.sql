...
INSERT INTO tracked_items (name, keywords, sku, mpn, category_id, marketplace, target_price, alert_threshold, min_deal_score, is_enabled, search_interval, scam_floor, benchmark_median, pcpp_product_id, notes) VALUES
    ...
    ('NVIDIA RTX 6000 Ada 48GB', 'NVIDIA RTX 6000 Ada workstation GPU 48GB', '900-5G133-2500-000', 'RTX 6000 Ada', '27386', 'ebay', 4200.00, 0.12, 65, true, 600, 3500.00, 4800.00, 'a6000A', 'Cheaper same-slot fallback for the build GPU. Legit used $4,500-5,500. Below $3,500 = scam.'),
