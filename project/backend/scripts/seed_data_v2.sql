...
INSERT INTO tracked_items (name, keywords, sku, mpn, category_id, marketplace, target_price, alert_threshold, min_deal_score, is_enabled, search_interval, scam_floor, benchmark_median, notes) VALUES
    ...
    ('Intel P5510 3.84TB U.2', 'Intel P5510 3.84TB U.2 NVMe enterprise SSD', 'SSDPE2KX038T801', 'P5510-4T', '56083', 'ebay', 500.00, 0.1, 60, true, 600, 400.00, 545.00, 'Best $/TB among P5510 sizes.'),
    ('Samsung PM9A3 1.92TB U.2', 'Samsung PM9A3 1.92TB U.2 NVMe enterprise SSD', 'MZQL21T9HCJR', 'PM9A3', '56083', 'ebay', 560.00, 0.1, 60, true, 600, 450.00, 607.00, 'Samsung brand premium. Offer 10% below BIN.'),
    ('Samsung PM9A3 3.84TB U.2', 'Samsung PM9A3 3.84TB U.2 NVMe enterprise SSD', 'MZQL23T8HCLS', 'PM9A3-4T', '56083', 'ebay', 920.00, 0.1, 65, true, 600, 750.00, 1023.00, 'Most expensive U.2 drive. Good performance but costly.'),
    ('Micron 7450 1.92TB U.2', 'Micron 7450 1.92TB U.2 NVMe enterprise SSD', 'MTFDKCB1T9TFS-1BC1ZABYY', '7450', '56083', 'ebay', 440.00, 0.1, 60, true, 600, 350.00, 475.00, 'Good availability. Best value current-gen U.2.'),
    ('Micron 7450 Pro 3.84TB U.2', 'Micron 7450 Pro 3.84TB U.2 NVMe enterprise SSD', 'MTFDKCB3T8TFS-1BC15ABYY', '7450-4T', '56083', 'ebay', 620.00, 0.1, 60, true, 600, 500.00, 673.00, 'Best $/TB at ~$162/TB. $500 was anomaly listing.'),
