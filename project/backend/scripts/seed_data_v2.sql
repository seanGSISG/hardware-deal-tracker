...
INSERT INTO tracked_items (name, keywords, sku, mpn, category_id, marketplace, target_price, alert_threshold, min_deal_score, is_enabled, search_interval, scam_floor, benchmark_median, notes) VALUES
    ...
    ('Supermicro H12SSL-CT', 'Supermicro H12SSL-CT motherboard SP3 EPYC', 'MBD-H12SSL-CT-O', 'H12SSL-CT', '1244', 'ebay', 650.00, 0.1, 65, true, 600, 500.00, 634.00, 'Pre-owned risen from $620. Watch for open-box at $600-700.'),
    ...
    ('NVIDIA RTX PRO 6000 Blackwell 96GB', 'NVIDIA RTX PRO 6000 Blackwell Workstation 96GB GPU', '900-5G180-2550-000', 'RTX PRO 6000', '27386', 'ebay', 6500.00, 0.1, 70, true, 1800, 7000.00, 7999.00, 'SCAM WARNING: Listings below $7,000 are confirmed scams. Too new for used market.'),
    ...
    ('NVIDIA T4 16GB', 'NVIDIA T4 16GB GPU inference accelerator', '900-2G183-0000-000', 'T4', '27386', 'ebay', 450.00, 0.2, 60, true, 300, 250.00, 637.00, 'US sellers $565+. China direct $280-420.'),
    ('Samsung 64GB DDR4-2933 ECC M393A8G40MB2-CVF', 'Samsung M393A8G40MB2-CVF 64GB DDR4 ECC RDIMM server memory', 'M393A8G40MB2-CVF', 'M393A8G40MB2-CVF', '170083', 'ebay', 135.00, 0.2, 60, true, 300, 100.00, 240.00, 'DDR4 prices RISING. Buy sooner. Target OBO at 20-30% below BIN.'),
    ('Samsung 64GB DDR4-3200 ECC M393A8G40AB2-CWE', 'Samsung M393A8G40AB2-CWE 64GB DDR4 ECC RDIMM server memory', 'M393A8G40AB2-CWE', 'M393A8G40AB2-CWE', '170083', 'ebay', 115.00, 0.2, 60, true, 300, 85.00, 145.00, 'Best value. Reddit r/homelabsales lots at $90/unit.'),
    ('Micron 64GB DDR4-2933 ECC MTA36ASF8G72PZ-2G9', 'Micron MTA36ASF8G72PZ-2G9 64GB DDR4 ECC RDIMM server memory', 'MTA36ASF8G72PZ-2G9', 'MTA36ASF8G72PZ-2G9', '170083', 'ebay', 125.00, 0.2, 60, true, 300, 100.00, 185.00, 'Good availability. $125 via OBO or used pulls.'),
    ...
    ('SilverStone RM52 5U Rackmount Chassis', 'SilverStone RM52 5U rackmount chassis server case', 'SST-RM52', 'RM52', '42014', 'ebay', 530.00, 0.1, 55, true, 1200, 450.00, 585.00, 'Niche product, no used market. Watch for seasonal sales.'),
    ...
    ('Mellanox ConnectX-5 25GbE MCX512A', 'Mellanox ConnectX-5 25GbE SFP28 network adapter MCX512A', 'MCX512A-ACAT', 'ConnectX-5', '51167', 'ebay', 50.00, 0.2, 60, true, 600, 25.00, 65.00, 'EOL Jan 2025 = liquidation inventory.'),
    ...
    ('Intel P5510 1.92TB U.2', 'Intel P5510 1.92TB U.2 NVMe enterprise SSD', 'SSDPE2KX019T801', 'P5510', '175669', 'ebay', 360.00, 0.15, 60, true, 600, 300.00, 400.00, 'Consider older P4510 at $150-250 as budget alternative.'),
    ('Intel P5510 3.84TB U.2', 'Intel P5510 3.84TB U.2 NVMe enterprise SSD', 'SSDPE2KX038T801', 'P5510-4T', '175669', 'ebay', 500.00, 0.1, 60, true, 600, 400.00, 545.00, 'Best $/TB among P5510 sizes.'),
    ('Samsung PM9A3 1.92TB U.2', 'Samsung PM9A3 1.92TB U.2 NVMe enterprise SSD', 'MZQL21T9HCJR', 'PM9A3', '175669', 'ebay', 560.00, 0.1, 60, true, 600, 450.00, 607.00, 'Samsung brand premium. Offer 10% below BIN.'),
    ('Samsung PM9A3 3.84TB U.2', 'Samsung PM9A3 3.84TB U.2 NVMe enterprise SSD', 'MZQL23T8HCLS', 'PM9A3-4T', '175669', 'ebay', 920.00, 0.1, 65, true, 600, 750.00, 1023.00, 'Most expensive U.2 drive. Good performance but costly.'),
    ('Micron 7450 1.92TB U.2', 'Micron 7450 1.92TB U.2 NVMe enterprise SSD', 'MTFDKCB1T9TFS-1BC1ZABYY', '7450', '175669', 'ebay', 440.00, 0.1, 60, true, 600, 350.00, 475.00, 'Good availability. Best value current-gen U.2.'),
    ('Micron 7450 Pro 3.84TB U.2', 'Micron 7450 Pro 3.84TB U.2 NVMe enterprise SSD', 'MTFDKCB3T8TFS-1BC15ABYY', '7450-4T', '175669', 'ebay', 620.00, 0.1, 60, true, 600, 500.00, 673.00, 'Best $/TB at ~$162/TB. $500 was anomaly listing.'),
    ...
    ('Seagate Exos X18 18TB', 'Seagate Exos X18 18TB ST18000NM000J enterprise HDD SATA', 'ST18000NM000J', 'ST18000NM000J', '56083', 'ebay', 270.00, 0.1, 60, true, 600, 220.00, 296.00, '$16.44/TB. 4x RAIDZ2 = 36TB usable ~$1,080.'),
    ('WD Ultrastar HC550 16TB', 'WD Ultrastar HC550 16TB WUH721816ALE6L4 enterprise HDD SATA', 'WUH721816ALE6L4', 'WUH721816ALE6L4', '56083', 'ebay', 265.00, 0.1, 60, true, 600, 200.00, 295.00, 'Reliable alternative to Exos. $18.44/TB.'),
    ('WD Ultrastar HC550 18TB', 'WD Ultrastar HC550 18TB WUH721818ALE6L4 enterprise HDD SATA', 'WUH721818ALE6L4', 'WUH721818ALE6L4', '56083', 'ebay', 260.00, 0.1, 60, true, 600, 200.00, 280.00, 'BEST $/TB at $15.56/TB! 4x RAIDZ2 = 36TB usable ~$1,040. RECOMMENDED.'),
    ...
    ('GPU Support Bracket Anti-Sag', 'GPU support bracket anti sag holder workstation', '', '', '42014', 'ebay', 7.00, 0.3, 50, true, 1200, 4.00, 10.00, 'Pure commodity. China $4-8. Do not overpay.'),
