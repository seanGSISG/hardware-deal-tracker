...
INSERT INTO tracked_items (name, keywords, sku, mpn, category_id, marketplace, target_price, alert_threshold, min_deal_score, is_enabled, search_interval, scam_floor, benchmark_median, pcpp_product_id, notes) VALUES
    ...
    ('AMD EPYC 7543P', 'AMD EPYC 7543P server CPU processor SP3', '100-000000341', '7543P', '164', 'ebay', 750.00, 0.15, 60, true, 600, 480.00, 900.00, NULL, '32C/64T Milan, 256MB L3, single-socket P-variant (cheaper than 7543). Buy <$750. Flag <$480 as suspicious (vendor-locked/fake). Combos price >$1500 so this part-only target ignores them.'),
    ...
    ('Supermicro H12SSL-i', 'Supermicro H12SSL-i motherboard SP3 EPYC', 'MBD-H12SSL-i-O', 'H12SSL-i', '1244', 'ebay', 600.00, 0.12, 65, true, 600, 400.00, 720.00, NULL, 'ATX single-socket SP3, 5x PCIe4 x16 (GPU-ready). Cheaper -i variant (no onboard HBA/10GbE vs -CT). Buy <$600. Board supply thin, expect to wait for a dip.'),
    ('ASRock Rack ROMED8-2T', 'ASRock Rack ROMED8-2T motherboard SP3 EPYC', 'ROMED8-2T', 'ROMED8-2T', '1244', 'ebay', 780.00, 0.12, 60, true, 600, 520.00, 1003.00, NULL, 'Retuned target 900->780 per Sean (2026-06-19), realistic fair-price alert. Live median ~$1003. New boards $1,000-1,080.'),
    ...
    ('Intel P5510 1.92TB U.2', 'Intel P5510 1.92TB U.2 NVMe enterprise SSD', 'SSDPE2KX019T801', 'P5510', '175669', 'ebay', 360.00, 0.15, 60, true, 600, 300.00, 400.00, NULL, 'Consider older P4510 at $150-250 as budget alternative.'),
    ('Intel P5510 3.84TB U.2', 'Intel P5510 3.84TB U.2 NVMe enterprise SSD', 'SSDPE2KX038T801', 'P5510-4T', '175669', 'ebay', 500.00, 0.1, 60, true, 600, 400.00, 545.00, NULL, 'Best $/TB among P5510 sizes.'),
    ('Samsung PM9A3 1.92TB U.2', 'Samsung PM9A3 1.92TB U.2 NVMe enterprise SSD', 'MZQL21T9HCJR', 'PM9A3', '175669', 'ebay', 560.00, 0.1, 60, true, 600, 450.00, 607.00, NULL, 'Samsung brand premium. Offer 10% below BIN.'),
    ('Samsung PM9A3 3.84TB U.2', 'Samsung PM9A3 3.84TB U.2 NVMe enterprise SSD', 'MZQL23T8HCLS', 'PM9A3-4T', '175669', 'ebay', 920.00, 0.1, 65, true, 600, 750.00, 1023.00, NULL, 'Most expensive U.2 drive. Good performance but costly.'),
    ('Micron 7450 1.92TB U.2', 'Micron 7450 1.92TB U.2 NVMe enterprise SSD', 'MTFDKCB1T9TFS-1BC1ZABYY', '7450', '175669', 'ebay', 440.00, 0.1, 60, true, 600, 350.00, 475.00, NULL, 'Good availability. Best value current-gen U.2.'),
    ('Micron 7450 Pro 3.84TB U.2', 'Micron 7450 Pro 3.84TB U.2 NVMe enterprise SSD', 'MTFDKCB3T8TFS-1BC15ABYY', '7450-4T', '175669', 'ebay', 620.00, 0.1, 60, true, 600, 500.00, 673.00, NULL, 'Best $/TB at ~$162/TB. $500 was anomaly listing.'),
